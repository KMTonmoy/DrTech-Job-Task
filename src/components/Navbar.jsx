    ...
    <div className={`p-3 flex flex-wrap justify-between items-center border-b-2 ${theme === 'dark' ? 'border-gray-700 bg-gray-900 text-white' : 'border-[#E5E7EB] bg-white text-black'} relative`}>
      ...
      <div className="hidden md:flex flex-wrap md:flex-row md:justify-end w-full md:w-auto gap-4 text-lg font-medium mt-4 md:mt-0 items-center">
        ...
        <Link
          ...
          className={`flex items-center gap-1 hover:text-[#0009FF] ${theme === 'dark' ? 'dark:hover:text-blue-400 dark:text-gray-300' : ''}`}
        >
          <span className="text-[#1A56DB] dark:text-blue-400 text-2xl">
            <IoMdCart />
          </span>
          Shop Now
        </Link>
          ...
          >
            ...
            <div className="flex flex-col gap-5 text-lg font-medium">
              ...
              <Link
                href="https://peacehoney.in/"
                onClick={toggleMenu}
                className={`flex items-center gap-2 hover:text-[#0009FF] ${theme === 'dark' ? 'dark:hover:text-blue-400 dark:text-gray-300' : ''}`}
              >
                <span className="text-[#1A56DB] dark:text-blue-400 text-2xl">
                  <IoMdCart />
                </span>
